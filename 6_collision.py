...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/user/Documents/pythonproject/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/user/Documents/pythonproject/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/user/Documents/pythonproject/pygame_basic/enemy.png")
...
# 20 fps : 1초 동안에 20번 동작 -> 1번에 5만큼! 5 * 20 = 100
    ...
    for event in pygame.event.get(): # 어떤 이벤트가 발생했는가?
        ...
        if event.type == pygame.KEYDOWN: # 키가 눌러졌는지 확인
            if event.key == pygame.K_LEFT: # 캐릭터를 왼쪽으로
                to_x -= character_speed   # to_x = to+x - 5
    ...
    pygame.display.update() # 게임 화면을 다시 그리기 (계속 계속)
